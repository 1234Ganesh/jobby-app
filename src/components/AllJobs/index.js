  ...
  onFailJobsView = () => (
    <>
      <div className="failure-img-btn-con">
        ...
        <div className="jobs-failure-btn-con">
          <button
      ...
      <>
        ...
        <div className="body-con">
          ...
          <div className="side-bar-con">
            ...
            <hr className="hr-line" />
            <h className="text">Salary Range</h>
            {this.onGetRadioButtonsView()}
          </div>
          <div className="jobs-con">
            <div className="lg-search-con">{this.onRenderSearch()}</div>
            {this.onRenderJobs()}
          </div>
        </div>
      </>
